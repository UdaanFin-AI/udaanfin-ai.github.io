...
function setTheme(mode){document.body.classList.toggle('dark',mode==='dark');const b=$('#theme-toggle');if(b)b.textContent=mode==='dark'?'☀':'☾';localStorage.setItem('UdaanFin-theme',mode)}
setTheme(localStorage.getItem('UdaanFin-theme')||'light'); $('#theme-toggle')?.addEventListener('click',()=>setTheme(document.body.classList.contains('dark')?'light':'dark'));
